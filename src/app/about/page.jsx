...
export default function About() {
  return (
    <div>
    <div>
            <span className="text-red-500 font-bold scroll text-md md:text-lg">The Internet's Best Alternative to Convertio and CloudConvert</span>

    </div>
    <div className="space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8 mb-10">
      <p>
        Introducing Zipzy, the ultimate multimedia conversion powerhouse that
      ...
      <div className="space-y-2">
        ...
        <p>
          Access Zipzy from any device with an internet connection. Whether
      ...
      <div className="space-y-2">
        <h2 className="text-xl md:text-2xl font-medium text-muted-foreground">
          🌟 It's Free, It's Powerful, It's Zipzy:
        </h2>
        <p>
